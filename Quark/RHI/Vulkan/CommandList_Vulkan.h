...
enum CommandListDirtyFlagBits
{
    ...
    COMMAND_LIST_DIRTY_PIPELINE_BIT = 1 << 1,
};
...
struct BindingState
{
    ...
    uint64_t cookies[DESCRIPTOR_SET_MAX_NUM][SET_BINDINGS_MAX_NUM];
...
private:
    ...
    CommandListDirtyFlagBits GetAndClearDirtyFlags(CommandListDirtyFlagBits flags);
