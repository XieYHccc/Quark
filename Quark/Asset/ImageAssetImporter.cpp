...
namespace quark 
{
    ...
    Ref<ImageAsset> ImageAssetImporter::Import(const std::string& file_path)
    {
    ...
    Ref<ImageAsset> ImageAssetImporter::ImportKtx(const std::string& file_path, bool isCubemap)
    {
        return nullptr;
    }

    Ref<ImageAsset> ImageAssetImporter::ImportKtx2(const std::string& file_path, bool isCubemap)
    {
    ...
    Ref<ImageAsset> ImageAssetImporter::ImportStb(const std::string& file_path)
    {
