...
VkPipeline PipelineBuilder::BuildPipeline()
{
    ...
    if (vkCreateGraphicsPipelines(RendererVulkan::GetInstance()->GetVkDevice(), VK_NULL_HANDLE, 1, &pipelineInfo,
            nullptr, &newPipeline) != VK_SUCCESS) 
	{
        XE_CLINET_ERROR("failed to create pipeline");
...
void PipelineBuilder::setShaders(VkShaderModule vertexShader, VkShaderModule fragmentShader)
{
	...
	shaderStages.push_back(
		vkutil::pipeline_shader_stage_create_info(VK_SHADER_STAGE_VERTEX_BIT, vertexShader));
	shaderStages.push_back(
		vkutil::pipeline_shader_stage_create_info(VK_SHADER_STAGE_FRAGMENT_BIT, fragmentShader));
}
